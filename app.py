...
def build_worksheet_prompt(data: dict) -> tuple[str, str]:
    ...
    user_prompt = (
        ...
        f'### TYMM KALİTE KONTROL RAPORU\n'
        f'- [✓] Bağlamın İşlevselliği: Bağlam metni ve veri seti gerçektir; öğrenci veriyi incelemeden akıl yürütemez.\n'
        f'- [✓] Süreç ve Bilişsel Basamak Uyumu: Çözümleme ve yorumlama süreç bileşenleri aşama aşama işletilmektedir.\n'
        f'- [✓] Etik, Değer ve Tarafsızlık: İnsani erdemler ve kainattaki hikmet boyutu pedagojik incelikle dengelenmiştir.\n'
        f'- [✓] Rubrik ve Ölçme Güvenilirliği: 4 ölçütlü analitik rubrik, öğrenme kanıtlarını net olarak görünür kılar.\n\n'
        f'TASARIM MOTORU KURALLARI:\n'
        f'- Öğrenci bölümleri ve öğretmen rubriğini yukarıdaki yapıya sadık kalarak eksiksiz oluştur.\n'
...
def build_test_prompt(data: dict) -> tuple[str, str]:
    system_instruction = (
        ...
        'ölçen bir YAPRAK TEST (Bağlam Temelli / Çoktan Seçmeli) hazırlamaktır.\n\n'
        'Bilişsel Düzeyler:\n'
        ...
        '- Sorularda gerçek yaşam bağlamları, grafikler, modeller veya tablolar kullan (Bağlam süs olmamalı, verisiz çözülememelidir).\n'
        '- MMR boyutu için inancı doğrudan ölçen sorular sorma. Nizam, ölçü ve hikmet boyutunu akıl yürütmeye dayalı sor.\n'
        '- Testin en sonunda mutlaka CEVAP ANAHTARI VE BİLİŞSEL DÜZEY MATRİSİ tablosu ile TYMM KALİTE KONTROL RAPORU ekle.'
    )
    ...
    user_prompt = (
        ...
        f'### TYMM KALİTE KONTROL RAPORU\n'
        f'- [✓] Bağlamın İşlevselliği: Bağlam metinleri/verileri süs değil, sorular doğrudan bağlam analizine dayanmaktadır.\n'
        f'- [✓] Süreç ve Bilişsel Basamak Uyumu: Sorular hedeflenen eylem fiili ve süreç bileşeniyle tam örtüşmektedir.\n'
        f'- [✓] Etik, Değer ve Tarafsızlık: Bilimsel doğruluk, hakkaniyet ve MMR tefekkür/ölçü ilkeleri korunmuştur.\n'
        f'- [✓] Rubrik ve Ölçme Güvenilirliği: Doğru cevaplar tartışmasız, çeldiriciler kavram yanılgılarına dayalıdır.\n\n'
...
def build_case_study_prompt(data: dict) -> tuple[str, str]:
    ...
    system_instruction = (
        ...
        'Öğrenci materyali KESİNLİKLE VE SADECE aşağıdaki 3 ana başlık altında oluşturulacaktır:\n\n'
        ...
        'VAKA ANALİZİNİN SONUNDA MUTLAKA:\n'
        '1) ÖĞRETMEN DEĞERLENDİRME ANALİTİK RUBRİĞİ (Veri Analizi: 4p, Kanıt Kullanımı: 4p, Neden-Sonuç: 4p, Çözüm Uygunluğu: 4p, Gerekçelendirme & Yansıtma: 4p | Toplam: 20p)\n'
        '2) TYMM KALİTE KONTROL RAPORU (Bağlam işlevselliği, süreç uyumu, etik tarafsızlık, rubrik güvenilirliği maddeleri).\n\n'
        'TASARIM KURALLARI:\n'
    ...
    user_prompt = (
        ...
        f'Süreç Bileşeni: {process_comp}\n'
        f'Manevi Öğrenme Çıktısı (MMR): {data.get("manevi_outcome", "")}\n\n'
        f'MATERYALDE SADECE VE SADECE ŞU ANA BÖLÜMLER OLACAKTIR:\n\n'
        ...
        f'| Veri Analizi | Vakadaki verileri ayırt edemez. | Temel verileri tespit eder ancak eksiktir. | Tüm verileri eksiksiz ve doğru analiz eder. |\n'
        f'| Kanıt Kullanımı | Çıkarımlarında kanıt sunmaz. | Kısmi kanıt kullanır. | Kararlarını somut kanıtlarla destekler. |\n'
        f'| Neden-Sonuç İlişkisi | İlişkileri kurmakta zorlanır. | Temel neden-sonuçları görür. | Çok boyutlu neden-sonuç ağını çözer. |\n'
        f'| Çözüm ve Karar | Gelişigüzel karar verir. | Makul ama sığ çözümler üretir. | Gerekçeli, uygulanabilir özgün çözüm sunar. |\n'
        ...
        f'### TYMM KALİTE KONTROL RAPORU\n'
        f'- [✓] Bağlamın İşlevselliği: Vaka senaryosu gerçektir, öğrencinin verileri okumadan ve durumu analiz etmeden cevap vermesi imkansızdır.\n'
        f'- [✓] Süreç ve Bilişsel Basamak Uyumu: Analiz ve değerlendirme basamaklarında hedeflenen süreç bileşeniyle tam örtüşmektedir.\n'
        f'- [✓] Etik, Değer ve Tarafsızlık: Ahlaki erdemler, insanlık onuru ve kâinattaki hikmet boyutu pedagojik incelikle işlenmiştir.\n'
        f'- [✓] Rubrik ve Ölçme Güvenilirliği: 5 ölçütlü analitik rubrik, öğrencinin performansını net biçimde görünür kılar.'
    )
...
def build_mind_map_prompt(data: dict) -> tuple[str, str]:
    ...
    system_instruction = (
        ...
        'EN SONDA MUTLAKA ÖĞRETMEN DEĞERLENDİRME RUBRİĞİ VE TYMM KALİTE KONTROL RAPORU BULUNMALIDIR.\n\n'
        'TASARIM KURALLARI:\n'
    ...
    user_prompt = (
        ...
        f'| Ana Fikrin Doğruluğu | Çekirdek kavramı tespit edemez. | Ana kavramı belirler, odak eksiktir. | Ana fikri kusursuz örgütler. |\n'
        f'| Alt Başlık Uygunluğu | Alt kavramlar ilgisizdir. | Temel alt dalları kurar. | Tüm alt dalları hiyerarşik ve doğru konumlandırır. |\n'
        f'| İlişkilendirme ve Akış | Oklar ve bağlar eksiktir. | Basit bağlantılar kurar. | Çok yönlü sebep-sonuç ve akış kurar. |\n'
        f'| Görsel Hiyerarşi | Düzensiz ve karmaşıktır. | Kısmi düzen içerir. | Net, okunabilir, hiyerarşik ağ düzeni oluşturur. |\n'
        f'| Bütünlük ve Tefekkür | Bütünsel bağı göremez. | Nizamı kısmen fark eder. | Parçadan bütüne kâinattaki sanatı ve şuur boyutunu açıklar. |\n\n'
        f'### TYMM KALİTE KONTROL RAPORU\n'
        f'- [✓] Bilişsel Örgütleme Uyumu: Kavramlar arası hiyerarşi ve mantıksal örgütleme ilkelerine tam uygundur.\n'
        f'- [✓] Süreç ve Bilişsel Basamak Uyumu: Öğrencinin yapılandırma ve ilişkilendirme süreçlerini görünür kılar.\n'
        f'- [✓] Etik, Değer ve Tarafsızlık: Bütünlük (vahdet) ve nizam sentezi pedagojik doğallıkla verilmiştir.\n'
        f'- [✓] Rubrik ve Ölçme Güvenilirliği: Öğrencinin zihinsel haritalama becerisini objektif puanlamaya elverişlidir.'
    )
...
def build_ai_outcome_analysis_prompt(data):
    ...
    system_instruction = (
        ...
        'Görevin, öğretmenin girdiği öğrenme çıktısını 3 KATMANLI MİMARİYE göre analiz ederek en uygun ölçme araçlarını önermektir:\n\n'
        '1. KATMAN — ANALİZ MOTORU:\n'
        'Öğrenme çıktısını yalnızca konu bilgisine göre değerlendirme. Eylem fiillerini, bilişsel düzeyi, beceriyi, süreç bileşenini, '
        'öğrenciden beklenen davranışı ve oluşması beklenen öğrenme kanıtını titizlikle ayrıştır.\n\n'
        '2. KATMAN — ÖNERİ MOTORU:\n'
        'Bu analizi MEB Kılavuzundaki 9 Temel Ölçme Aracının profilleriyle karşılaştır:\n'
        '1. Yaprak Test (70-90 Puan): Tanıma, hatırlama, bilgi tarama.\n'
        '2. Bağlam Temelli Test (85-100 Puan): Gerçek yaşam bağlamında bilgiyi işletme, grafik/tablo/senaryo analizi.\n'
        '3. Açık Uçlu Soru (80-95 Puan): Düşünce sürecini serbest yapılandırma, gerekçelendirme.\n'
        '4. Doğru-Yanlış (40-70 Puan): Hızlı önerme kontrolü, temel bilgi teyidi.\n'
        '5. Eşleştirme (50-75 Puan): İki bilgi kümesi arası ilişki kurma.\n'
        '6. Vaka Analizi (90-100 Puan): Çok boyutlu durum tespiti, veri analizi, çıkarım, hikmet ve insani sorumluluk.\n'
        '7. Problem Çözme Görevi (90-100 Puan): Rutin olmayan durumlar, kısıtlar, strateji ve gerekçeli karar.\n'
        '8. Kavram Haritası (80-95 Puan): Önerme bağları ve kavram yanılgılarını belirleme.\n'
        '9. Zihin Haritası (80-95 Puan): Örgütleme, yapılandırma ve bütünlük (vahdet) sentezi.\n\n'
        'ÇIKTIYI KESİNLİKLE ŞU BÖLÜM VE FORMATTA VER:\n'
        '# 1. KATMAN — ANALİZ MOTORU (Öğrenme Çıktısı Pedagojik Analizi)\n'
        '1. Öğrenme çıktısı: ...\n'
        '2. Ana eylem fiili: ...\n'
        '3. Bilişsel düzey: ...\n'
        '4. İçerik alanı: ...\n'
        ...
        '# 2. KATMAN — ÖNERİ MOTORU (9 Ölçme Aracı Karşılaştırma ve En Uygun 3 Araç)\n'
        '### Tüm Ölçme Araçları Uygunluk Matrisi (0–100)\n'
    ...
    user_prompt = (
        f'Aşağıda verilen parametrelere göre öğrenme çıktısını 3 KATMANLI MİMARİ doğrultusunda analiz et ve TYMM ölçme araçları raporunu hazırla:\n\n'
        f'Ders: {subject}\n'
        f'Sınıf: {grade}\n'
        f'Konu / Tema: {topic}\n'
...
def build_dual_tools_prompt(data):
    ...
    system_instruction = (
        ...
        '4. BÖLÜM: TYMM KALİTE KONTROL RAPORU (Bağlam işlevselliği, süreç uyumu, etik/tarafsızlık, rubrik güvenilirliği).'
    )
    ...
    user_prompt = (
        ...
        f'Süreç Bileşeni: {process_comp}\n'
        f'Manevi Öğrenme Çıktısı (MMR): {data.get("manevi_outcome", "")}\n\n'
        f'İçeriği 4 ana başlık altında tamamla: (1. Birincil Araç, 2. İkincil Araç, 3. Öğretmen Rubriği, 4. TYMM Kalite Kontrol Raporu).'
    )
