...
def build_ai_outcome_analysis_prompt(data):
    ...
    system_instruction = (
        ...
        'ÖĞRENME ÇIKTISI DEĞERLENDİRME İLKELERİ:\n'
        ...
        'ARAÇ PROFİLLERİ VE KARAR KRİTERLERİ (TYMM Standartları):\n'
        '1. YAPRAK TEST (70-90 Puan): Bilgi/kavrama hızlı tarama. Fiiller: tanımlar, açıklar, sınıflandırır, ayırt eder, hesaplar. Zayıf: tasarlar, model oluşturur, deney yapar.\n'
        '2. BAĞLAM TEMELLİ ÇOKTAN SEÇMELİ TEST (85-100 Puan): Bilgiyi otantik bağlamda kullanma. Fiiller: yorumlar, analiz eder, çıkarım yapar, değerlendirir, neden-sonuç kurar. 12 Bağlam Türü (Gerçek yaşam, bilimsel olay, deney, grafik, tablo, haber, günlük problem, çevre, teknoloji, sosyal durum, veri seti, senaryo).\n'
        '3. AÇIK UÇLU SORU (80-95 Puan): Düşünce sürecini serbest yapılandırma. Fiiller: açıklar, gerekçelendirir, kanıtlar, çözüm önerir. Analitik Rubrik şarttır.\n'
        '4. DOĞRU-YANLIŞ (40-70 Puan): Hızlı önerme kontrolü. Fiiller: tanımlar, belirler, ayırt eder. İfade tek anlamlı, açık ve bilimsel kesin olmalıdır.\n'
        '5. EŞLEŞTİRME (50-75 Puan): İki bilgi kümesi arası ilişki. (Kavram→Tanım, Bilim insanı→Çalışma, Organ→Görev, Enerji türü→Örnek, Sembol→Anlam, Olay→Sonuç).\n'
        '6. VAKA ANALİZİ (90-100 Puan): Katmanlı gerçekçi durum çözümlemesi. (1. Vaka bağlamı, 2. Problem, 3. Veri, 4. Görev, 5. Değerlendirme). Rubrik: Veri analizi(4), Kanıt kullanımı(4), Neden-sonuç(4), Çözüm uygunluğu(4), Gerekçelendirme(4).\n'
        '7. PROBLEM ÇÖZME GÖREVİ (90-100 Puan): Rutin olmayan problem stratejisi (Problem→Veriler→Kısıtlar→Görev→Çözüm→Gerekçe→Değerlendirme). Türler: Matematik, Fen, Günlük yaşam, Mühendislik, Çevre, Enerji, Veri analizi, Tasarım.\n'
        '8. KAVRAM HARİTASI (80-95 Puan): Kavramlar arası önerme ilişkileri ve hiyerarşik bağların doğrulanması.\n'
        '9. ZİHİN HARİTASI (80-95 Puan): Merkezî kavramdan dallanarak (Ana Dal→Alt Dal→Ayrıntı) serbest fikir organizasyonu ve bütünlük (vahdet) sentezi.\n\n'
