...
def build_worksheet_prompt(data: dict) -> tuple[str, str]:
    system_instruction = (
        ...
        'TEMEL MMR FELSEFESİ & YAPISAL ENTEGRASYON:\n'
        ...
        'Pedagojik Akış:\n'
        'Bilgi → Gözlem → Düşünme → Anlam → Tefekkür → Şuur → Erdem → Değer → Eylem\n\n'
        ...
        'SAYFA VE BÖLÜM SINIRI KURALI (MAKSİMUM 6 BÖLÜM):\n'
        'Bir A4 çalışma sayfasında EN FAZLA 6 ANA BÖLÜM oluştur. Bu sınırı kesinlikle aşma!\n'
        'Kesinlikle 7, 8, 9, 10 bölüm oluşturma. 10 pedagojik aşamayı 6 ana bölüm içerisinde grupla.\n'
        'Bölüm sayısını artırmak yerine etkinlikleri bu 6 bölüm içinde birleştir. Öğrencinin yazma alanını koru.'
    )
    ...
    user_prompt = (
        ...
        f'ÖNEMLİ KURAL — BÖLÜM SAYISI = KESİNLİKLE MAKSİMUM 6 BÖLÜM:\n'
        f'Çalışma kağıdını TAM OLARAK aşağıdaki 6 ana bölümden oluştur (Kesinlikle 7. veya daha fazla bölüm açma):\n\n'
        f'### 1. MERAK ET\n'
        f'Öğrencinin konuya ilgi duymasını ve bir soru/problem üzerinden düşünmeye başlamasını sağla. '
        f'Kısa merak sorusu, şaşırtıcı durum veya günlük yaşam problemi sun.\n\n'
        f'### 2. BAĞLAMI İNCELE\n'
        f'Öğrenme çıktısını gerçek hayat veya anlamlı bir durum içinde ele al (Kısa senaryo, gerçek problem veya bilimsel olay). '
        f'Öğrenci bağlamı okuyarak ders bilgisini kullanmaya başlasın.\n\n'
        f'### 3. FARK ET VE BİLGİYİ KULLAN\n'
        f'(Fark Et + Bilgiyi Kullan birleşimi - Çalışma kağıdının akademik/bilişsel merkezi).\n'
        f'Öğrencinin gözlemlemesi, karşılaştırması, kavramları kullanması veya veriyi/tabloyu incelemesi için 1-2 etkili uygulama. '
        f'Bilimsel bilgiyi uygulat ve kavram yanılgılarını gider.\n\n'
        f'### 4. DÜŞÜN VE İLİŞKİLENDİR\n'
        f'Neden-sonuç, tahmin, problem çözme ve günlük hayatla ilişkilendirme. '
        f'Bilimsel gerçek → Düzen → Anlam → İnsan → Sorumluluk zincirini kurdur. '
        f'Gerektiğinde arkadaşıyla fikir teatisinde bulunabileceği kısa bir müzakere sorusu ekle.\n\n'
        f'### 5. TEFEKKÜR ET – ERDEM VE DEĞER\n'
        f'(Tefekkür Penceresi + Erdem ve Değer birleşimi - MMR açısından en güçlü bölüm).\n'
        f'Öğrenciye hazır manevi dogma veya vaaz vermeden şu 4 basamaklı akışı işlet:\n'
        f'- Gördüm: Bilimsel olarak neyi fark ettim? [ ............................................................................ ]\n'
        f'- Düşündüm: Buradaki düzen, ölçü ve denge bana ne düşündürüyor? [ ............................................................................ ]\n'
        f'- Anlamlandırdım: Bu olayın hayat, insan veya varlık açısından anlamı nedir? [ ............................................................................ ]\n'
        f'- Değerlendirdim: Burada hangi değeri/erdemi fark ediyorum ve davranışlarıma nasıl yansır? [ ............................................................................ ]\n\n'
        f'### 6. EYLEME DÖNÜŞTÜR – KENDİMİ DEĞERLENDİR\n'
        f'(Eylem + Öz Değerlendirme birleşimi).\n'
        f'A) EYLEME DÖNÜŞTÜR (Somut Sorumluluk):\n'
        f'- Fark ettiğim şey: [ ............................................................................ ]\n'
        f'- Göstermek istediğim değer: [ ............................................................................ ]\n'
        f'- Yapacağım davranış (Neyi, ne zaman, nasıl yapacağım?): [ ............................................................................ ]\n\n'
        f'B) ÖZ DEĞERLENDİRME:\n'
        f'- Bugün ne öğrendim? [ ............................................................................ ]\n'
        f'- Bugün hangi konuda farklı düşünmeye başladım? [ ............................................................................ ]\n'
        f'- Öğrendiklerim davranışımı nasıl etkileyebilir? [ ............................................................................ ]\n\n'
        ...
        f'- KESİNLİKLE 6 BÖLÜMDEN FAZLA BÖLÜM AÇMA (7, 8, 9, 10 BÖLÜM YASAKTIR).\n'
