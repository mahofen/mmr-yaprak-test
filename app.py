...
def build_worksheet_prompt(data: dict) -> tuple[str, str]:
    system_instruction = (
        ...
        'Kelime sayısıyla maneviyat oluşturma; anlamlandırma derinliğini esas al.'
    )
    ...
    user_prompt = (
        ...
        f'6. TEFEKKÜR PENCERESİ (4 Aşamalı Mimari): Diğer tüm bölümlerle tamamen AYNI tasarım düzeninde, aynı kart hiyerarşisinde ve soru akışıyla şu 4 aşamayı uygulat:\n'
        ...
        f'7. ERDEM VE DEĞER (Derinleştirilmiş Akış): Değeri doğrudan söyleme. Tablo veya akış formatında şu adımları işlet:\n'
        ...
        f'- Tefekkür Penceresi dahil tüm bölümleri aynı başlık hiyerarşisi, aynı kart düzeni ve aynı tasarım bütünlüğünde sun.\n'
